...
from trainers.bert_classifier import BertClassifier
...
def main(experiment_name: Optional[str],
    ...
    bert_trainer = BertClassifier(experiment_name=experiment_name,
                               data_path=train_path,
                               save_signature=save_signature,
                               registered_model_version_stage=registered_model_version_stage,  # noqa
                               output_path=output_path)
    
    bert_trainer.train(registered_model_name=registered_model_name,
                      plot_file=plot_file)
